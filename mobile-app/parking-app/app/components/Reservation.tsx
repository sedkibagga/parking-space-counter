        ...
        <View className='bg-black h-full flex flex-col'>
            ...
            <Modal visible={showReservationModal} animationType="slide">
                <View className='bg-black h-full flex flex-col'>
                    ...
                    <View className='flex flex-col h-1/2 px-5 mt-5'>
                        ...
                        <View className='flex flex-row items-center justify-center mt-5'>
                            <TextInput
                                ...
                                maxLength={10}
                                className='bg-white p-3 rounded-lg w-3/4 text-center'
                            />
                        </View>
                        ...
                        <View className='flex flex-row items-center justify-center mt-8'>
                            ...
                            >
                                <Text className='text-white text-xl font-semibold'>Submit Reservation</Text>
                            </Pressable>
                        </View>
                    </View>
                    ...
                    <View className='flex flex-row items-center justify-center mt-5'>
                        <Text className='text-white text-sm'>
                            Need assistance?{' '}
                            <Text className='text-blue-400 underline' onPress={() => { }}>
                                Contact Support
                            </Text>
                        </Text>
                    </View>
                ...
                >
                    <ScrollView className='bg-black h-full flex flex-col'>
                        ...
                        <View className='flex flex-col items-center justify-center mt-5'>
                            ...
                            <Button title='Go Back' onPress={() => setShowFactureModal(false)} color="white" />
                        </View>
                    </ScrollView>
                </KeyboardAvoidingView>
            </Modal>
